...
function readSensors(sensor, count) {
    isInfo && logger_1.info(`In readSensors. sensor.name '${sensor.name}', sensor.pin '${sensor.pin}', count '${count}'.`);
...
function onNewSensorReadout(sensorName, temperatureC, humidityRel) {
    return __awaiter(this, void 0, void 0, function* () {
        isInfo && logger_1.info(`In onNewSensorReadout. sensorName '${sensorName}', temperatureC '${temperatureC}', humidityRel '${humidityRel}'.`);
...
function onTwoMinuteIntervall() {
    isInfo && logger_1.info("In onTwoMinuteIntervall.");
...
function writeSensorVal(fd, sensorVal, date, addNewLine, writeAtBeginning) {
    return __awaiter(this, void 0, void 0, function* () {
        isInfo && logger_1.info(`In writeSensorVal. fd '${fd}',  sensorVal '${sensorVal}', date '${date}', addNewLine '${addNewLine}'.`);
...
function openFilesEnsureHeader() {
    return __awaiter(this, void 0, void 0, function* () {
        isInfo && logger_1.info("In openFilesEnsureHeader");
        function openFilesEnsureHeaderHelper(filePath, header) {
            return __awaiter(this, void 0, void 0, function* () {
                isInfo && logger_1.info(`Opening or creating file '${filePath}' and writing header if it contains zero bytes.`);
        ...
        for (const sensor of config.sensors) {
            ...
            isInfo && logger_1.info(`Creating directory '${dir}' for sensor data files if not existing.`);
