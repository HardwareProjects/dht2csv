...
function writeSensorVal(fd, sensorVal, date, addNewLine, writeAtBeginning) {
    return __awaiter(this, void 0, void 0, function* () {
        isInfo && log.info(`In writeSensorVal. fd '${fd}',  sensorVal '${sensorVal}', date '${date}', addNewLine '${addNewLine}'.`);
...
function openFilesEnsureHeader() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const sensor of config.sensors) {
            const dir = path.resolve(exports.baseDir, config.sensordataBasepath, sensor.dataSubdirectory);
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        log = new log_helper_1.Logger(logConfig);
        isInfo = log_helper_1.isInfoOrVerboser(logConfig.levelFilter);
