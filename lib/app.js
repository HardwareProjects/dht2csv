...
let isInfo = null;
const error = log_helper_1.getLogger(log_helper_1.Loglevel.ERROR, path.basename(__filename));
const warn = log_helper_1.getLogger(log_helper_1.Loglevel.WARN, path.basename(__filename));
const info = log_helper_1.getLogger(log_helper_1.Loglevel.INFO, path.basename(__filename));
...
function onNewSensorReadout(sensorPin, temperatureC, humidityRel) {
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        config = yield config_helper_1.processConfig(baseDir, configFileName, warn);
        isInfo = log_helper_1.isInfoOrVerboser(config.loglevel);
